...
public class SuperLikePW extends BasePopupWindow {
    ...
    private void start3() {
        binding.ivStar3.setVisibility(View.VISIBLE);
        ObjectAnimator ivStar2X = ObjectAnimator.ofFloat(binding.ivStar3, "translationX", 0, leftX1 + 50, leftX2 - 150).setDuration(time);
    ...
    private void start6() {
        binding.ivStar6.setVisibility(View.VISIBLE);
        ObjectAnimator ivStar2X = ObjectAnimator.ofFloat(binding.ivStar6, "translationX", 0, rightX1 - 40, rightX2 + 180).setDuration(time);
