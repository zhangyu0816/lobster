...
public class RouteUtils {
    ...
    // 对话页
    public static final String Flash_Chat_Activity = "/chat/FlashChatActivity";
    // 匹配
    ...
    public static final String Camera_Film_Resource_Detail = "/camera/FilmResourceDetailActivity";
