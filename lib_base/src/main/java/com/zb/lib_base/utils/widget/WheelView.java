...
public class WheelView extends View {
    ...
    // The number of first item_check_add_balance in layout
    ...
    /**
     * Sets the current item_check_add_balance. Does nothing when index is wrong.
     *
     * @param index    the item_check_add_balance index
    ...
    /**
     * Sets the current item_check_add_balance w/o animation. Does nothing when index is wrong.
     *
     * @param index the item_check_add_balance index
     */
    ...
    /**
     * Tests if wheel is cyclic. That means before the 1st item_check_add_balance there is shown
     * the last one
     *
    ...
    /**
     * Returns height of wheel item_check_add_balance
     *
     * @return the item_check_add_balance height
     */
    ...
    /**
     * Creates item_check_add_balance layouts if necessary
     */
    ...
    /**
     * Adds view for item_check_add_balance to items layout
     *
     * @param index the item_check_add_balance index
     * @param first the flag indicates if view should be first
     * @return true if corresponding item_check_add_balance exists and is added
     */
     ...
     *
     * @param index the item_check_add_balance index
     * @return true if item_check_add_balance index is not out of bounds or the wheel is cyclic
     */
    ...
    /**
     * Returns view for specified item_check_add_balance
     *
     * @param index the item_check_add_balance index
     * @return item_check_add_balance view or empty view if index is out of bounds
     */
