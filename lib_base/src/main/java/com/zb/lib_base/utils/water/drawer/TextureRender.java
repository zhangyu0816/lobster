package com.zb.lib_base.utils.water.drawer;
...
import com.zb.lib_base.utils.water.GPUImageFilter;
import com.zb.lib_base.utils.water.WaterMark;
import com.zb.lib_base.utils.water.bean.VideoInfo;
import com.zb.lib_base.utils.water.filter.AFilter;
import com.zb.lib_base.utils.water.filter.GroupFilter;
import com.zb.lib_base.utils.water.filter.NoFilter;
import com.zb.lib_base.utils.water.filter.RotationOESFilter;
import com.zb.lib_base.utils.water.filter.WaterMarkFilter;
import com.zb.lib_base.utils.water.util.EasyGlUtils;
import com.zb.lib_base.utils.water.util.MatrixUtils;
...
//    };
    ...
    public TextureRender(VideoInfo info) {
        ...
        Resources resources = MineApp.getApp().getResources();
        ...
        waterMarkFilter.setWaterMark(WaterMark.waterBitmap);
        waterMarkFilter.setPosition(10, 10, WaterMark.waterBitmap.getWidth(), WaterMark.waterBitmap.getHeight());
...
//        st.getTransformMatrix(mSTMatrix);//当视频角度不为0时,这里会导致视频方向不对
    ...
    public void setVideoWidthAndHeight(VideoInfo info) {
        ...
        if (info.rotation == 0 || info.rotation == 180) {
            ...
            videoWidth = info.height;
            videoHeight = info.width;
        }
    }
